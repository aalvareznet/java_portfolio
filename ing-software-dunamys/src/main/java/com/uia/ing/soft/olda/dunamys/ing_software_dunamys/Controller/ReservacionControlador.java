...
public class ReservacionControlador {
    ...
    public ResponseEntity<Reservacion> actualizarReservacion(@PathVariable Long id
        ...
        if(busquedaReservacion.isPresent()){
            ...
            auditoria.guardarAccion(userId, "Reservacion ID " + reservacionActualizada.getId() + " actualizada", "reservacion");
    ...
    public ResponseEntity<Reservacion> cancelarReservacion(@PathVariable Long id
        ...
        if(busquedaReservacion.isPresent()){
            ...
            Reservacion reservacionActualizada = servicio.update(reservacionParaActualizar);
            auditoria.guardarAccion(userId, "Reservacion ID " + reservacionActualizada.getId() + " cancelada", "reservacion");
            return ResponseEntity.ok(reservacionActualizada);
        }
        return ResponseEntity.notFound().build();
    }
